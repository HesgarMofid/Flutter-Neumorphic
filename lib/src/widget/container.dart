...
@immutable
class SimpleNeumorphic extends StatelessWidget {
  static const DEFAULT_DURATION = const Duration(milliseconds: 100);
  static const DEFAULT_CURVE = Curves.linear;
  ...
  Widget build(BuildContext context) {
    ...
    return _SimpleNeumorphicContainer(
      padding: this.padding,
      textStyle: this.textStyle,
      drawSurfaceAboveChild: this.drawSurfaceAboveChild,
      duration: this.duration,
...
class _SimpleNeumorphicContainer extends StatelessWidget {
  final NeumorphicStyle style;
  final TextStyle? textStyle;
  final Widget? child;
  final EdgeInsets margin;
